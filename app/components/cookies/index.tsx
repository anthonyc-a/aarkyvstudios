...
const Cookies = () => {
  ...
  return (
    <>
      {!show && (
        <div className="cookies bg-[#08080828] backdrop-blur grow w-full max-w-[620px] md:whitespace-nowrap fixed bottom-4 md:bottom-10 right-0 md:right-8 border hover:border-[#555] border-[#222]">
