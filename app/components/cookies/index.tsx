  ...
  return (
    <>
      {show && (
        ...
        <div className="cookies rounded-md  clip bg-[#fff] grow backdrop-blur md:whitespace-nowrap fixed bottom-3 md:bottom-5 left-2 md:right-8 border  border-[#000]">
          <div className="w-full h-full p-4 flex items-center justify-between">
            ...
            <div className="flex gap-6">
              <span
                className=" underline whitespace-nowrap text-[0.68rem] font-[500] hover:decoration-transparent"
                onClick={close}
              >
                I understand
              </span>
